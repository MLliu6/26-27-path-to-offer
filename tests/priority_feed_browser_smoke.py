...
def main() -> int:
    with sync_playwright() as p:
        ...
        page.wait_for_function("() => window.PTO_PRIORITY_FEED_READY === true", timeout=15_000)
        ...
        text = exact.inner_text()
        assert "拼多多" in text and "AI Infra研发工程师" in text
        ...
        assert "每 10 分钟" in source_text
        assert "拼多多校园招聘官网" in source_text
        assert "24 条" in source_text
